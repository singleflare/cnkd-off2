...
let letterOpenSequences = Array(64).fill(0)
...
const showPuzzleSequence1 = [0,1,16, 17, 32, 33, 48, 49]
const showPuzzleSequence2 = [2,3,18, 19, 34, 35, 50, 51]
const showPuzzleSequence3 = [4,5,20, 21, 36, 37, 52, 53]
const showPuzzleSequence4 = [6,7,22, 23, 38, 39, 54, 55]
const showPuzzleSequence5 = [8,9,24, 25, 40, 41, 56, 57]
const showPuzzleSequence6 = [10,11,26, 27, 42, 43, 58, 59]
const showPuzzleSequence7 = [12,13,28, 29, 44, 45, 60, 61]
const showPuzzleSequence8 = [14,15,30, 31, 46, 47, 62, 63]
...
function showPuzzle(puzzleArray) {
  showPuzzleSequences.forEach((showPuzzleSequence, index) => {
    ...
    }, index * 300); // Delay each iteration by index * 1000 milliseconds
  })
}
...
puzzleSocket.on('sendPuzzleToPuzzleBoard', (data) => {
  resetPuzzle()
  letterOpenSequences = Array(64).fill(0)
